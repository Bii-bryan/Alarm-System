# Alarm-System
Using an ultrasonic sensor (HC-SR04) with Arduino Uno R3, assembling it and implementing it on an alarm system.
Components: Arduino Uno R4, Ultrasonic sensor (HC SR04), Active buzzer 5V (HXD), Breadboard, Jumper wires
...
- Upload the alarm-system-arduino.ino file
